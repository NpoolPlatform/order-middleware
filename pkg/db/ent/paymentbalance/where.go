...
func ID(id uint32) predicate.PaymentBalance {
	return predicate.PaymentBalance(func(s *sql.Selector) {
...
func OrderID(v uuid.UUID) predicate.PaymentBalance {
	return predicate.PaymentBalance(func(s *sql.Selector) {
...
func OrderIDEQ(v uuid.UUID) predicate.PaymentBalance {
	return predicate.PaymentBalance(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldOrderID), v))
	})
}
...
func OrderIDNEQ(v uuid.UUID) predicate.PaymentBalance {
	return predicate.PaymentBalance(func(s *sql.Selector) {
...
func OrderIDIn(vs ...uuid.UUID) predicate.PaymentBalance {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func OrderIDNotIn(vs ...uuid.UUID) predicate.PaymentBalance {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func OrderIDGT(v uuid.UUID) predicate.PaymentBalance {
	return predicate.PaymentBalance(func(s *sql.Selector) {
...
func OrderIDGTE(v uuid.UUID) predicate.PaymentBalance {
	return predicate.PaymentBalance(func(s *sql.Selector) {
...
func OrderIDLT(v uuid.UUID) predicate.PaymentBalance {
	return predicate.PaymentBalance(func(s *sql.Selector) {
...
func OrderIDLTE(v uuid.UUID) predicate.PaymentBalance {
	return predicate.PaymentBalance(func(s *sql.Selector) {
...
func OrderIDIsNil() predicate.PaymentBalance {
	return predicate.PaymentBalance(func(s *sql.Selector) {
...
func OrderIDNotNil() predicate.PaymentBalance {
	return predicate.PaymentBalance(func(s *sql.Selector) {
