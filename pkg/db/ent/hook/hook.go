...
// The PaymentBalanceLockFunc type is an adapter to allow the use of ordinary
// function as PaymentBalanceLock mutator.
type PaymentBalanceLockFunc func(context.Context, *ent.PaymentBalanceLockMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PaymentBalanceLockFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.PaymentBalanceLockMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PaymentBalanceLockMutation", m)
	}
	return f(ctx, mv)
}
...
// The PoolOrderUserFunc type is an adapter to allow the use of ordinary
// function as PoolOrderUser mutator.
type PoolOrderUserFunc func(context.Context, *ent.PoolOrderUserMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PoolOrderUserFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.PoolOrderUserMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PoolOrderUserMutation", m)
	}
	return f(ctx, mv)
}
