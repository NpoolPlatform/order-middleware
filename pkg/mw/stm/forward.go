...
var forwards = map[types.OrderState][]types.OrderState{
	...
	types.OrderState_OrderStatePreExpired:                  {types.OrderState_OrderStateRestoreExpiredStock, types.OrderState_OrderStateDeleteProportion},
	types.OrderState_OrderStateRestoreExpiredStock:         {types.OrderState_OrderStateExpired, types.OrderState_OrderStateCheckPoolBalance},
	types.OrderState_OrderStateDeleteProportion:            {types.OrderState_OrderStateRestoreExpiredStock},
