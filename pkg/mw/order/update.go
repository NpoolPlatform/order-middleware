...
var stateAllowMap = map[types.OrderState][]types.OrderState{
	...
	types.OrderState_OrderStateAchievementBookKeeping:     {types.OrderState_OrderStateAchievementBookKept},
	types.OrderState_OrderStateAchievementBookKept:        {types.OrderState_OrderStatePaid},
...
var stateRollbackMap = map[types.OrderState]*types.OrderState{
	...
	types.OrderState_OrderStateAchievementBookKept:        types.OrderState_OrderStateAchievementBookKeeping.Enum(),
	types.OrderState_OrderStatePaid:                       types.OrderState_OrderStateAchievementBookKept.Enum(),
