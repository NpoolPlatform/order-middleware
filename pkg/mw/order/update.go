...
var stateAllowMap = map[types.OrderState][]types.OrderState{
	...
	types.OrderState_OrderStateUpdatePaidChilds:            {types.OrderState_OrderStateChildPaidByParent},
	...
	types.OrderState_OrderStateUpdateInServiceChilds:       {types.OrderState_OrderStateChildInServiceByParent},
	...
	types.OrderState_OrderStateUpdateExpiredChilds:         {types.OrderState_OrderStateChildExpiredByParent},
	...
	types.OrderState_OrderStateUpdateCanceledChilds:        {types.OrderState_OrderStateChildCanceledByParent},
