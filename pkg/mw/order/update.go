...
var stateAllowMap = map[types.OrderState][]types.OrderState{
	...
	types.OrderState_OrderStateAchievementBookKeeping:     {types.OrderState_OrderStateUpdateWaitPaymentChilds},
	types.OrderState_OrderStateUpdateWaitPaymentChilds:    {types.OrderState_OrderStatePaid},
	...
	types.OrderState_OrderStateUpdatePaidChilds:           {types.OrderState_OrderStateInService},
	...
	types.OrderState_OrderStateTransferGoodStockInService: {types.OrderState_OrderStateUpdateInServiceChilds},
	types.OrderState_OrderStateUpdateInServiceChilds:      {types.OrderState_OrderStatePreExpired},
...
var stateRollbackMap = map[types.OrderState]*types.OrderState{
	...
	types.OrderState_OrderStateUpdateWaitPaymentChilds:    types.OrderState_OrderStateAchievementBookKeeping.Enum(),
	types.OrderState_OrderStatePaid:                       types.OrderState_OrderStateUpdateWaitPaymentChilds.Enum(),
	types.OrderState_OrderStateTransferGoodStockWaitStart: types.OrderState_OrderStatePaid.Enum(),
	types.OrderState_OrderStateUpdatePaidChilds:           types.OrderState_OrderStateTransferGoodStockWaitStart.Enum(),
	types.OrderState_OrderStateTransferGoodStockInService: types.OrderState_OrderStateInService.Enum(),
	types.OrderState_OrderStateUpdateInServiceChilds:      types.OrderState_OrderStateTransferGoodStockInService.Enum(),
