...
var stateAllowMap = map[basetypes.OrderState][]basetypes.OrderState{
	...
	basetypes.OrderState_OrderStateGoodStockTransferredCheck:    {basetypes.OrderState_OrderStateAchievementBookKept},
...
var stateRollbackMap = map[basetypes.OrderState]*basetypes.OrderState{
	...
	basetypes.OrderState_OrderStateAchievementBookKept:     basetypes.OrderState_OrderStateGoodStockTransferredCheck.Enum(),
